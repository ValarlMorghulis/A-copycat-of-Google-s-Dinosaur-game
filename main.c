...
int main(int argc,char*argv[]) {
    ...
    SDL_Texture* pause = IMG_LoadTexture(renderer,"resources/pause.png");
    SDL_Texture* left = IMG_LoadTexture(renderer, "resources/left.png");
    SDL_Texture* right = IMG_LoadTexture(renderer, "resources/right.png");
    SDL_Texture* down = IMG_LoadTexture(renderer, "resources/down.png");
    SDL_Texture* fly1 = IMG_LoadTexture(renderer, "resources/fly1.png");
    SDL_Texture* fly2 = IMG_LoadTexture(renderer, "resources/fly2.png");
    SDL_Texture* big = IMG_LoadTexture(renderer, "resources/big.png");
    SDL_Texture* big2 = IMG_LoadTexture(renderer, "resources/big2.png");
    SDL_Texture* middle = IMG_LoadTexture(renderer, "resources/middle.png");
    SDL_Texture* small = IMG_LoadTexture(renderer, "resources/small.png");
    SDL_Texture* cloud = IMG_LoadTexture(renderer, "resources/cloud.png");
    SDL_Texture* gameover = IMG_LoadTexture(renderer, "resources/over.png");
    SDL_Texture* ground = IMG_LoadTexture(renderer,"resources/ground.png");
    SDL_Texture* stop = IMG_LoadTexture(renderer, "resources/stop.png");//载入图片
